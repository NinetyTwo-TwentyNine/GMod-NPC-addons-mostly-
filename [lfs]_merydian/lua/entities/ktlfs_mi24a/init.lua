...
function ENT:RunOnSpawn()
	...
	self:GetDriverSeat().ExitPos = Vector(182,65,-152)
	
	local GunnerSeat = self:AddPassengerSeat( Vector(182,-1.5,-152), Angle(0,-90,3) )
	GunnerSeat.ExitPos = Vector(182,65,-152)
	
	self:SetGunnerSeat( GunnerSeat )
	
	self:AddPassengerSeat( Vector(0,5,-141), Angle(0,0,0) ).ExitPos = Vector(15,84,-141)
	self:AddPassengerSeat( Vector(20,5,-141), Angle(0,0,0) ).ExitPos = Vector(15,84,-141)

	self:AddPassengerSeat( Vector(0,-7,-141), Angle(0,-180,0) ).ExitPos = Vector(15,-84,-141)
	self:AddPassengerSeat( Vector(20,-7,-141), Angle(0,-180,0) ).ExitPos = Vector(15,-84,-141)
...
function ENT:SecondaryAttack()
	...
	local Pos = self:LocalToWorld( Vector(22,155 * (self.FireLeft and 1 or -1),-149) )
	ent:SetPos( Pos )
...
function ENT:HandleWeapons(Fire1, Fire2, Fire3)
	...
	if self.OldFire3 ~= Fire3 then
		if Fire3 then
			self.wpn2 = CreateSound( self, "2A42_FIRE_LOOP" )
			self.wpn2:Play()
...
function ENT:OnLandingGearToggled( bOn )
	...
	if bOn then
		self:PlayAnimation("gearup")
	else
		self:PlayAnimation("geardown")
	end
end
