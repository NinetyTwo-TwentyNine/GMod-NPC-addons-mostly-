...
function ENT:PrimaryAttack()
	...
	local bullet = {}
	bullet.Num 	= 1
	bullet.Src 	= self:LocalToWorld( Vector(300,0,98) )
...
function ENT:RunOnSpawn()
	...
	local SpawnedPod = self:AddPassengerSeat( Vector(105,0,105), Angle(0,270,0) )
...
function ENT:HandleWeapons(Fire1, Fire2)
	...
	if self.OldFire ~= Fire1 then
		...
		if Fire1 then
			self.wpn1 = CreateSound( self, "F18_GUN_LOOP" )
			self.wpn1:Play()
