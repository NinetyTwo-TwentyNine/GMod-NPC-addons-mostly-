...
function ENT:PrimaryAttack()
	...
	local bullet = {}
	bullet.Num 	= 1
	bullet.Src 	= self:LocalToWorld( Vector(140,0,-10) )
...
function ENT:SecondaryAttack()
	...
	local Pos = self:LocalToWorld( Vector(-58,110 * Mirror,-50) )
...
function ENT:RunOnSpawn()
	...
	local SpawnedPod = self:AddPassengerSeat( Vector(140,0,10), Angle(0,270,0) )
