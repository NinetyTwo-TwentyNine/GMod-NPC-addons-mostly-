...
self.ActivityTranslateAI [ACT_WALK] = ACT_WALK_AR2

self.ActivityTranslateAI [ACT_MP_RUN] = ACT_HL2MP_RUN_AR2

self.ActivityTranslateAI [ACT_IDLE_RELAXED] = ACT_IDLE_AR2_RELAXED

self.ActivityTranslateAI [ACT_IDLE_STIMULATED] = ACT_IDLE_AR2_STIMULATED
...
self.ActivityTranslateAI [ACT_WALK_RELAXED] = ACT_WALK_AR2_RELAXED

self.ActivityTranslateAI [ACT_WALK_STIMULATED] = ACT_WALK_AR2_STIMULATED

self.ActivityTranslateAI [ACT_WALK_AGITATED] = ACT_WALK_AIM_AR2


self.ActivityTranslateAI [ACT_RUN_RELAXED] = ACT_RUN_AR2_RELAXED

self.ActivityTranslateAI [ACT_RUN_STIMULATED] = ACT_RUN_AR2_STIMULATED

self.ActivityTranslateAI [ACT_RUN_AGITATED] = ACT_RUN_AIM_AR2


self.ActivityTranslateAI [ACT_IDLE_AIM_RELAXED] = ACT_IDLE_AR2_RELAXED

self.ActivityTranslateAI [ACT_IDLE_AIM_STIMULATED] = ACT_IDLE_AIM_AR2_STIMULATED

self.ActivityTranslateAI [ACT_IDLE_AIM_AGITATED] = ACT_IDLE_ANGRY_AR2


self.ActivityTranslateAI [ACT_WALK_AIM_RELAXED] = ACT_WALK_AR2_RELAXED

self.ActivityTranslateAI [ACT_WALK_AIM_STIMULATED] = ACT_WALK_AIM_AR2_STIMULATED

self.ActivityTranslateAI [ACT_WALK_AIM_AGITATED] = ACT_WALK_AIM_AR2


self.ActivityTranslateAI [ACT_RUN_AIM_RELAXED] = ACT_RUN_AR2_RELAXED

self.ActivityTranslateAI [ACT_RUN_AIM_STIMULATED] = ACT_RUN_AIM_AR2_STIMULATED

self.ActivityTranslateAI [ACT_RUN_AIM_AGITATED] = ACT_RUN_AIM_AR2


self.ActivityTranslateAI [ACT_WALK_AIM] = ACT_WALK_AIM_AR2

self.ActivityTranslateAI [ACT_WALK_CROUCH] = ACT_WALK_CROUCH_AR2

self.ActivityTranslateAI [ACT_WALK_CROUCH_AIM] = ACT_WALK_CROUCH_AIM_AR2

self.ActivityTranslateAI [ACT_RUN] = ACT_RUN_AR2

self.ActivityTranslateAI [ACT_RUN_AIM] = ACT_RUN_AIM_AR2

self.ActivityTranslateAI [ACT_RUN_CROUCH] = ACT_RUN_CROUCH_AR2

self.ActivityTranslateAI [ACT_RUN_CROUCH_AIM] = ACT_RUN_CROUCH_AIM_AR2
...
self.ActivityTranslateAI [ACT_GESTURE_RELOAD] = ACT_RELOAD_AR2
