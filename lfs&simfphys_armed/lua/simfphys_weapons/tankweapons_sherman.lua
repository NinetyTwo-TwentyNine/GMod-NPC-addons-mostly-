...
local function cannon_fire(ply,vehicle,shootOrigin,shootDirection)
	...
	vehicle:EmitSound("simulated_vehicles/weapons/tiger_reload.wav", 70, math.random(120, 140), 1, CHAN_STREAM)
...
function simfphys.weapon:Initialize( vehicle )
	...
	vehicle:SetNWFloat( "SpecialCam_LoaderTime", 4.00 )
...
function simfphys.weapon:PrimaryAttack( vehicle, ply, shootOrigin, Attachment )
	...
	self:SetNextPrimaryFire( vehicle, CurTime() + 4.00 )
end
