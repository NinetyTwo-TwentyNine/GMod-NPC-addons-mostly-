...
local ent = ents.Create( "npc_overwatch_squad_tier2_dropship" )
...
self.npc:SetName( "Tier 2 Overwatch Dropship")
...
timer.Simple(2,function()
	...
	undo.Create( "Overwatch Tier 2 Dropship" )
	undo.SetCustomUndoText( "Undone Tier 2 Overwatch Dropship" )
...
local npc = self.npc
	...
	if npc:GetNWBool("HasTroops") == true and IsValid(Crate) and Crate:GetParent() == npc and npc:GetName() == "Tier 2 Overwatch Dropship" and Crate:GetName() == "dropship_container" and not self.SquadDeploying then
...
local Open_Idle = self.container:LookupSequence( "open_idle" )
						...
						self.SquadDeploying = true
							...
							self.Combine_Soldier1:SetKeyValue( "squadname", "Tier 2 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							self.Combine_Soldier1:Give( "weapon_smg1" )
							self.Combine_Soldier1:Spawn()
							self.Combine_Soldier1:Activate()
						local Combine_Soldier1_name = "DeployingTier2OverWatchSoldier1" .. self.Combine_Soldier1:EntIndex()
						self.Combine_Soldier1:SetName( Combine_Soldier1_name )
							...
							self.Combine_Soldier2:SetKeyValue( "squadname", "Tier 2 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier2:Give( "weapon_smg1" )
							self.Combine_Soldier2:Spawn()
							self.Combine_Soldier2:Activate()
						local Combine_Soldier2_name = "DeployingTier2OverWatchSoldier2" .. self.Combine_Soldier2:EntIndex()
						self.Combine_Soldier2:SetName( Combine_Soldier2_name )
							...
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier3:SetKeyValue( "squadname", "Tier 2 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier3:Give( "weapon_ar2" )
							self.Combine_Soldier3:Spawn()
							self.Combine_Soldier3:Activate()
						local Combine_Soldier3_name = "DeployingTier2OverWatchSoldier3" .. self.Combine_Soldier3:EntIndex()
						self.Combine_Soldier3:SetName( Combine_Soldier3_name )
							...
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier4:SetKeyValue( "squadname", "Tier 2 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier4:Give( "weapon_ar2" )
							self.Combine_Soldier4:Spawn()
							self.Combine_Soldier4:Activate()
						local Combine_Soldier4_name = "DeployingTier2OverWatchSoldier4" .. self.Combine_Soldier4:EntIndex()
						self.Combine_Soldier4:SetName( Combine_Soldier4_name )
							...
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier5:SetKeyValue( "squadname", "Tier 2 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier5:Give( "weapon_ar2" )
							self.Combine_Soldier5:Spawn()
							self.Combine_Soldier5:Activate()
						local Combine_Soldier5_name = "DeployingTier2OverWatchSoldier5" .. self.Combine_Soldier5:EntIndex()
						self.Combine_Soldier5:SetName( Combine_Soldier5_name )
							...
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier6:SetKeyValue( "squadname", "Tier 2 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier6:Give( "weapon_shotgun" )
							self.Combine_Soldier6:Spawn()
							self.Combine_Soldier6:Activate()
						local Combine_Soldier6_name = "DeployingTier2OverWatchSoldier6" .. self.Combine_Soldier6:EntIndex()
						self.Combine_Soldier6:SetName( Combine_Soldier6_name )
							...
							self.Combine_Soldier6_Sequence:SetParent( self.Combine_Soldier6 )
								...
								timer.Simple(2.6666666666667,function()
									...
									self.Combine_Soldier6:SetLastPosition( self.container:GetPos() + self.container:GetForward()*450 + self.container:GetRight()*math.random(-50,-100) )
...
hook.Add("EntityTakeDamage", "Tier 2 Overwatch Dropship Damage", function(ent, dmginfo)

if ent:GetName() == "Tier 2 Overwatch Dropship" and dmginfo:IsDamageType(DMG_BLAST) and ent:Health() > 0 then
