...
local ent = ents.Create( "npc_civil_protection_tier3_dropship" )
...
self.npc:SetName( "Tier 3 Overwatch Dropship")
...
timer.Simple(2,function()
	...
	undo.Create( "Overwatch Tier 3 Dropship" )
	undo.AddEntity( DropShip_Corpse )	
	undo.SetCustomUndoText( "Undone Overwatch Tier 3 Dropship" )
	for _, DropShip_Corpse_To_Undo in pairs( player.GetAll()) do undo.SetPlayer(DropShip_Corpse_To_Undo) end 
	undo.Finish()
...
local npc = self.npc
	...
	if npc:GetNWBool("HasTroops") == true and IsValid(Crate) and Crate:GetParent() == npc and npc:GetName() == "Tier 3 Overwatch Dropship" and Crate:GetName() == "dropship_container" and not self.SquadDeploying then
...
local Open_Idle = self.container:LookupSequence( "open_idle" )
						...
						self.SquadDeploying = true
							...
							self.Combine_Soldier1:SetKeyValue( "squadname", "Tier 3 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier1:Give( "weapon_smg1" )
							self.Combine_Soldier1:Spawn()
							self.Combine_Soldier1:Activate()
						local Combine_Soldier1_name = "DeployingTier3OverWatchSoldier1" .. self.Combine_Soldier1:EntIndex()
						self.Combine_Soldier1:SetName( Combine_Soldier1_name )
							...
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier2:SetKeyValue( "squadname", "Tier 3 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier2:Give( "weapon_ar2" )
							self.Combine_Soldier2:Spawn()
							self.Combine_Soldier2:Activate()
						local Combine_Soldier2_name = "DeployingTier3OverWatchSoldier2" .. self.Combine_Soldier2:EntIndex()
						self.Combine_Soldier2:SetName( Combine_Soldier2_name )
							...
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier3:SetKeyValue( "squadname", "Tier 3 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end 
							self.Combine_Soldier3:Give( "weapon_ar2" )
							self.Combine_Soldier3:Spawn()
							self.Combine_Soldier3:Activate()
						local Combine_Soldier3_name = "DeployingTier3OverWatchSoldier3" .. self.Combine_Soldier3:EntIndex()
						self.Combine_Soldier3:SetName( Combine_Soldier3_name )
							...
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier4:SetKeyValue( "squadname","Tier 3 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end 
							self.Combine_Soldier4:Give( "weapon_ar2" )
							self.Combine_Soldier4:Spawn()
							self.Combine_Soldier4:Activate()
						local Combine_Soldier4_name = "DeployingTier3OverWatchSoldier4" .. self.Combine_Soldier4:EntIndex()
						self.Combine_Soldier4:SetName( Combine_Soldier4_name )
							...
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier5:SetKeyValue( "squadname","Tier 3 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier5:Give( "weapon_ar2" )
							self.Combine_Soldier5:Spawn()
							self.Combine_Soldier5:Activate()
						local Combine_Soldier5_name = "DeployingTier3OverWatchSoldier5" .. self.Combine_Soldier5:EntIndex()
						self.Combine_Soldier5:SetName( Combine_Soldier5_name )
							...
							timer.Simple(15,function()
								if IsValid(self.container) then
							self.Combine_Soldier6 = ents.Create( "npc_combine_s" )
							self.Combine_Soldier6:SetPos( self.container:GetPos() + self.container:GetForward()*-26 + self.container:GetUp()*-36 )
							self.Combine_Soldier6:SetKeyValue( "spawnflags", "644" )
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier6:SetKeyValue( "squadname", "Tier 3 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier6:Give( "weapon_shotgun" )
							self.Combine_Soldier6:Spawn()
							self.Combine_Soldier6:Activate()
						local Combine_Soldier6_name = "DeployingTier3OverWatchSoldier6" .. self.Combine_Soldier6:EntIndex()
						self.Combine_Soldier6:SetName( Combine_Soldier6_name )
							self.SequencePlayed = false
							self.Combine_Soldier6_Sequence = ents.Create( "scripted_sequence" )
							self.Combine_Soldier6_Sequence:SetName( Combine_Soldier6_name .. "_wake_seq" )
							self.Combine_Soldier6_Sequence:SetKeyValue( "spawnflags", "624" )
							self.Combine_Soldier6_Sequence:SetKeyValue( "m_iszEntity", Combine_Soldier6_name )
							self.Combine_Soldier6_Sequence:SetKeyValue( "m_iszIdle", "idle1" )
							self.Combine_Soldier6_Sequence:SetKeyValue( "m_fMoveTo", "4" )
							self.Combine_Soldier6_Sequence:SetKeyValue( "m_iszPlay", "Dropship_Deploy" )
							self.Combine_Soldier6_Sequence:SetPos( self.container:GetPos() + self.container:GetForward()*-26 + self.container:GetUp()*-36 )
							self.Combine_Soldier6_Sequence:Spawn()
							self.Combine_Soldier6_Sequence:Activate()
							self.Combine_Soldier6_Sequence:SetParent( self.Combine_Soldier6 )
								if self.SequencePlayed == false then
								self.Combine_Soldier6_Sequence:Fire( "BeginSequence", "", 0 )
								self.SequencePlayed = true
								timer.Simple(2.6666666666667,function()
									if IsValid(self.Combine_Soldier6) and self.SequencePlayed and IsValid(self.container) and not self.Combine_Soldier6:IsCurrentSchedule(SCHED_FORCED_GO_RUN) then
									self.Combine_Soldier6:ExitScriptedSequence()
									self.Combine_Soldier6:SetLastPosition( self.container:GetPos() + self.container:GetForward()*350 + self.container:GetRight()*math.random(-30,-50) )
									self.Combine_Soldier6:SetSchedule(SCHED_FORCED_GO_RUN)
									end
									end)
								end
								end
							...
							timer.Simple(18,function()
								if IsValid(self.container) then
							self.Combine_Soldier7 = ents.Create( "npc_combine_s" )
							self.Combine_Soldier7:SetPos( self.container:GetPos() + self.container:GetForward()*-26 + self.container:GetUp()*-36 )
							self.Combine_Soldier7:SetKeyValue( "spawnflags", "644" )
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier7:SetKeyValue( "squadname", "Tier 3 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier7:Give( "weapon_shotgun" )
							self.Combine_Soldier7:Spawn()
							self.Combine_Soldier7:Activate()
						local Combine_Soldier7_name = "DeployingTier3OverWatchSoldier7" .. self.Combine_Soldier7:EntIndex()
						self.Combine_Soldier7:SetName( Combine_Soldier7_name )
							self.SequencePlayed = false
							self.Combine_Soldier7_Sequence = ents.Create( "scripted_sequence" )
							self.Combine_Soldier7_Sequence:SetName( Combine_Soldier7_name .. "_wake_seq" )
							self.Combine_Soldier7_Sequence:SetKeyValue( "spawnflags", "624" )
							self.Combine_Soldier7_Sequence:SetKeyValue( "m_iszEntity", Combine_Soldier7_name )
							self.Combine_Soldier7_Sequence:SetKeyValue( "m_iszIdle", "idle1" )
							self.Combine_Soldier7_Sequence:SetKeyValue( "m_fMoveTo", "4" )
							self.Combine_Soldier7_Sequence:SetKeyValue( "m_iszPlay", "Dropship_Deploy" )
							self.Combine_Soldier7_Sequence:SetPos( self.container:GetPos() + self.container:GetForward()*-26 + self.container:GetUp()*-36 )
							self.Combine_Soldier7_Sequence:Spawn()
							self.Combine_Soldier7_Sequence:Activate()
							self.Combine_Soldier7_Sequence:SetParent( self.Combine_Soldier7 )
								if self.SequencePlayed == false then
								self.Combine_Soldier7_Sequence:Fire( "BeginSequence", "", 0 )
								self.SequencePlayed = true
								timer.Simple(2.6666666666667,function()
									if IsValid(self.Combine_Soldier7) and self.SequencePlayed and IsValid(self.container) and not self.Combine_Soldier7:IsCurrentSchedule(SCHED_FORCED_GO_RUN) then
									self.Combine_Soldier7:ExitScriptedSequence()
									self.Combine_Soldier7:SetLastPosition( self.container:GetPos() + self.container:GetForward()*350 + self.container:GetRight()*math.random(-30,-50) )
									self.Combine_Soldier7:SetSchedule(SCHED_FORCED_GO_RUN)
									end
									end)
								end
								end
							...
							timer.Simple(21,function()
								if IsValid(self.container) then
							self.Combine_Soldier8 = ents.Create( "npc_combine_s" )
							self.Combine_Soldier8:SetKeyValue( "model", "models/combine_super_soldier.mdl")
							self.Combine_Soldier8:SetPos( self.container:GetPos() + self.container:GetForward()*-26 + self.container:GetUp()*-36 )
							self.Combine_Soldier8:SetKeyValue( "spawnflags", "644" )
							if IsValid(self.Combine_Soldier1) then
							self.Combine_Soldier8:SetKeyValue( "squadname", "Tier 3 Overwatch Drop Squad".. self.Combine_Soldier1:EntIndex() )
							end
							self.Combine_Soldier8:Give( "weapon_ar2" )
							self.Combine_Soldier8:Spawn()
							self.Combine_Soldier8:Activate()
						local Combine_Soldier8_name = "DeployingTier3OverWatchSoldier8" .. self.Combine_Soldier8:EntIndex()
						self.Combine_Soldier8:SetName( Combine_Soldier8_name )
							self.SequencePlayed = false
							self.Combine_Soldier8_Sequence = ents.Create( "scripted_sequence" )
							self.Combine_Soldier8_Sequence:SetName( Combine_Soldier8_name .. "_wake_seq" )
							self.Combine_Soldier8_Sequence:SetKeyValue( "spawnflags", "624" )
							self.Combine_Soldier8_Sequence:SetKeyValue( "m_iszEntity", Combine_Soldier8_name )
							self.Combine_Soldier8_Sequence:SetKeyValue( "m_iszIdle", "idle1" )
							self.Combine_Soldier8_Sequence:SetKeyValue( "m_fMoveTo", "4" )
							self.Combine_Soldier8_Sequence:SetKeyValue( "m_iszPlay", "Dropship_Deploy" )
							self.Combine_Soldier8_Sequence:SetPos( self.container:GetPos() + self.container:GetForward()*-26 + self.container:GetUp()*-36 )
							self.Combine_Soldier8_Sequence:Spawn()
							self.Combine_Soldier8_Sequence:Activate()
							self.Combine_Soldier8_Sequence:SetParent( self.Combine_Soldier8 )
								if self.SequencePlayed == false then
								self.Combine_Soldier8_Sequence:Fire( "BeginSequence", "", 0 )
								self.SequencePlayed = true
								timer.Simple(2.6666666666667,function()
									if IsValid(self.Combine_Soldier8) and self.SequencePlayed and IsValid(self.container) and not self.Combine_Soldier8:IsCurrentSchedule(SCHED_FORCED_GO_RUN) then
									self.Combine_Soldier8:ExitScriptedSequence()
									self.Combine_Soldier8:SetLastPosition( self.container:GetPos() + self.container:GetForward()*350 + self.container:GetRight()*math.random(30,50) )
									self.Combine_Soldier8:SetSchedule(SCHED_FORCED_GO_RUN)
									end
									end)
								end
								end
...
hook.Add("EntityTakeDamage", "Tier 3 Overwatch Dropship Damage", function(ent, dmginfo)

if ent:GetName() == "Tier 3 Overwatch Dropship" and dmginfo:IsDamageType(DMG_BLAST) and ent:Health() > 0 then
